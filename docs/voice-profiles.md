...
## 0-1. 화법 대비 — 두 사람은 정반대로 말한다 ★

캐스팅 대비가 음역·속도·질감·억양에서 갈렸다면, **화법에서도 갈린다.**

| | 서연 | 민준 |
|---|---|---|
| 속마음 | **V.O.로 계속 흘린다** | 없다 |
| 현장 대사 | 최소한, 방어적, 삼킨다 | **혼잣말을 소리 내서 한다** |
| 성격 | 다 삼키고 속으로만 | 생각이 입으로 새어나온다 |

민준은 거울 앞에서 혼자 떠들고(1화 컷 2), "저기…" 하다 삼키고(1화 컷 5),
"저 우산 있어요" 하고 말이 꼬인다(2화 컷 5).
**그는 생각을 소리로 흘리는 사람이다.** 서연은 반대로 전부 삼키고 V.O.로만 샌다.

### 민준에게 V.O.를 주면 안 되는 이유

1. **캐릭터가 겹친다.** 두 사람 다 속마음을 흘리면 대비가 사라진다.
2. **3화 반전이 죽는다.** 1화에서 그의 속을 들으면 "이 사람 진심이다"가 즉시 들통난다.
   서연이 그걸 3화에서야 발견하는 것이 이 이야기의 전부다.

### 단 한 번의 예외 — 3화 컷 6

**민준의 V.O.는 영상 전체에서 딱 한 번, 손이 닿는 순간에만 나온다.**

```
민준 (V.O.): …어떡하지.
```

같은 컷에서 서연의 V.O.는 3화 내내 한 번도 없다.
**여기서 화자의 바통이 넘어간다.**

| 왜 강한가 | |
|---|---|
| ① | 말 못 하는 사람이 마침내 할 말이 있는데, **그때 처음으로 소리를 못 낸다.** 캐릭터가 뒤집히는 게 아니라 극한까지 간 것이다 |
| ② | 서연은 침묵하고 민준은 말한다. 관객이 **설명 없이 시점 교대를 느낀다** |
| ③ | 좋은 일이 생겼는데 "어떡하지"라고 하는 것 — 웃기면서 동시에 벅차다 |
| ④ | **한 번뿐이라 세다.** 두 번 쓰면 그냥 내레이션이 된다 |

⚠️ **이 한 줄 외에 민준의 V.O.를 어디에도 넣지 않는다.**
